...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país de un atleta por su nombre");
	...
	{
		System.out.println("\n" + "Encontrar país de atleta por nombre" + "\n");
		String nombreAtleta=input("Por favor ingrese el nombre de un atleta");
		String PaisAtleta = calculadora.atletasPorNombre(nombreAtleta);
		if (PaisAtleta == null)
		{
		...
		{
			System.out.println("El atleta "+nombreAtleta+" es del país "+PaisAtleta);
		}
	}
